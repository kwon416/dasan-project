...
<link rel="stylesheet" href="resources/css/dasan/search.css" />
...
<body>
	<div id="dashboardShell" class="dashboard-shell">
		<nav class="nav-bar">
			<div class="nav-inner">
				<div class="identity">
					<a href="#" class="nav-logo"> <img src="/resources/assets/index/logo.png"
						alt="120다산콜재단">
					</a>
		...
		<header class="hero-card">
			...
			<p class="hero-subtitle">검색 조건을 설정하고 기간 대비 증감률(PoP) 중심으로 추세를
				확인합니다.</p>
		</header>
		...
		<main class="dashboard-grid">
			<section class="card search-strip" aria-labelledby="searchStripTitle">
				...
				<form id="frm-search" method="get" action="search_result.do">
					<div class="search-row-top">
						<div class="district-field">
							<label for="districtSelect" class="sr-only">구 선택</label> <select
								id="districtSelect" class="krds-form-select" title="자치구 선택">
						...
						<div class="search-input-field">
							<label for="searchInput" class="sr-only">검색어</label> <input
								id="searchInput" type="text" class="krds-input"
								placeholder="검색어를 입력해주세요." autocomplete="off" />
						</div>

						<div class="action-buttons">
							<button id="resetButton" type="button"
								class="krds-btn medium tertiary reset-btn">초기화</button>
							<button id="searchButton" type="button"
								class="krds-btn medium search-btn">분석 시작</button>
						</div>
					</div>
					...
					<div class="search-row-bottom">
						<div class="period-presets">
							...
							<div id="quickPresetGroup" class="preset-group" role="group"
								aria-label="기간 프리셋">
						...
						<div class="period-range">
							...
							<div class="date-range-field" aria-label="시작일과 종료일">
								<input id="startDate" type="date" class="krds-input date-input"
									title="시작일" /> <span class="range-separator"
									aria-hidden="true">~</span> <input id="endDate" type="date"
									class="krds-input date-input" title="종료일" />
								<button id="datePickerButton" type="button"
									class="calendar-trigger hidden" aria-label="달력 열기">
					...
					<p id="searchError" class="search-error" role="alert"
						aria-live="polite"></p>
				</form>
				</div>
			</section>
						...
						<div class="widget-title-row">
							...
							<span class="tooltip-container">
								<button type="button" class="tooltip-trigger"
									aria-label="급상승 키워드 설명">i</button> <span class="tooltip-text">[데이터
									집계 기준]<br>• 전일: 전일 대비 증감량<br>• 3개월/6개월: 전년 동기 대비 증감량
									(계절성 반영)<br>• 1년: 직전 1년 대비 증감량<br>* 증감률(%)은 소수점 첫째
									자리까지 표기됩니다.
							</span>
							</span>
						</div>
						<p id="risingUpdated" class="card-subtitle" aria-live="polite">마지막
							집계: -</p>
					</div>
				...
				<article class="card widget-card" aria-labelledby="rankingTitle">
					<div class="card-head widget-head">
						<div class="widget-title-row">
							...
							<span class="tooltip-container">
								<button type="button" class="tooltip-trigger"
									aria-label="검색순위 설명">i</button> <span class="tooltip-text">[데이터
									집계 기준]<br>• 전일: 전일 대비 증감량<br>• 3개월/6개월: 전년 동기 대비 증감량
									(계절성 반영)<br>• 1년: 직전 1년 대비 증감량<br>* 증감률(%)은 소수점 첫째
									자리까지 표기됩니다.
							</span>
						...
						<p id="rankingUpdated" class="card-subtitle" aria-live="polite">마지막
							집계: -</p>
					</div>
			...
			<section class="card recommend-card" aria-labelledby="recommendTitle">
				...
				<div class="recommend-layout">
					<aside class="category-sidebar" aria-label="1단계 유형 필터">
						<div id="categorySidebar" class="category-nav" role="tablist"
	...
	<div id="analysisModal" class="modal-backdrop is-hidden" role="dialog"
		aria-modal="true" aria-labelledby="analysisModalTitle">
		<div class="confirm-modal">
			<h3 id="analysisModalTitle" class="modal-title">대량 데이터를 정밀
				분석하시겠습니까?</h3>
			...
			<div class="modal-actions">
				...
				<button id="analysisCancel" type="button"
					class="krds-btn medium tertiary">취소</button>
			</div>
		</div>
	</div>

	<div id="analysisOverlay" class="analysis-overlay is-hidden"
	...
	<script src="/resources/js/dasan/search.js"></script>
</body>
</html>
