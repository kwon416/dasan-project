...
//COMPLAINT
import EgovComplaintMain from "@/pages/complaint/EgovComplaintMain";
...
const SecondRoutes = () => {
  ...
  return (
    <>
      ...
      <Routes>
        {/* MAIN */}
        <Route path={URL.MAIN} element={<EgovComplaintMain />} />
        ...
        {/* COMPLAINT */}
        <Route path={URL.COMPLAINT} element={<EgovComplaintMain />} />
